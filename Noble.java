public class Noble {
    ...
    public void display() {
        ...
        System.out.println(ConsoleColors.WHITE + "Diamond:\t\t" + this.cardCost[0]);
        System.out.println(ConsoleColors.BLUE + "Sapphire:\t" + this.cardCost[1]);
        System.out.println(ConsoleColors.GREEN + "Emerald:\t\t" + this.cardCost[2]);
        System.out.println(ConsoleColors.RED + "Ruby:\t\t" + this.cardCost[3]);
